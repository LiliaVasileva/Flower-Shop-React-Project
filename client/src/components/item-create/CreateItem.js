...
function CreateItem() {
    ...
    return (
        <div className="create" id="create">
            ...
            <form method="POST" onSubmit={onSubmit} id="create__form" className="create__form" encType="multipart/form-data">
                ...
                <input type="text" id="description" name="description"  className="description" placeholder="Описание на продукта..." onChange={changeHandler}/>
                <input type="file" id="image" name="image" className="image" placeholder="Качи снимка..." onChange={changeHandler} />
